...
export class ChatSpotWidget extends CompositePanelWidgetBase {
    ...
    constructor(panel) {
        ...
        this.promptsStorageKey = 'chat_spot_active_prompts';
        ...
        this.prompts_el = $('<div class="prompt-list"></div>');
    ...
    renderDetection(data) {
        ...
        const message = { sender: 'spot', text: `[Detection] ${infoText} (${cameraShort})`, timestamp };
    ...
    renderPrompts() {
        ...
        for (const prompt of this.activePrompts) {
            let chip = $('<span class="prompt-chip"></span>');
